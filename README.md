# 📌 Curadoria de Recursos Úteis para Estudantes da Língua Japonesa
...
| ~~[Night Mode](https://ankiweb.net/shared/info/1496166067)~~ | Tema escuro para o Anki. Novas versões do Anki já possui a funcionalidade de tema dark **(descontinuado)** |
...
| 🇧🇷 [Easy Japanese](https://www3.nhk.or.jp/nhkworld/pt/shows/easyjapanese "Easy Japanese") | Nova versão Curso de Japonês da NHK |
...
| 🇺🇸 [Takoboto](https://takoboto.jp "Takoboto") |  Dicionário de japonês e gramática |
...
| 🇯🇵 [色彩アトラス](https://www.i-iro.com/dic/ "色彩アトラス")  | Guia de nomes de cores em japonês |
...
| Nome | Descrição | 
|:---- |:--------- |
| [Delvin Language](http://delvinlanguage.com "Delvin Language") | Pratique a sua compreensão auditiva transcrevendo o que ouvir no áudio |
...
| 🇺🇸 [Immersion Kit](https://www.immersionkit.com "Immersion Kit - Anime Sentences for Japanese Learners") | Pesquisar palavras e frases de anime com áudio e imagem, semelhante ao Nadeshiko. Possui integração com o Anki |
...
| 🇯🇵 [Kakijun](http://kakijun.com) | Pesquisar por um kanji desejado e ele mostra um `.gif` da ordem dos traços com marcação quadriculada, porém sem enumeração da ordem. Semelhante ao Yamasa |
| 🇺🇸 [Kanji Canvas](https://asdfjkl.github.io/kanjicanvas) | Realizar pesquisa de kanjis escrevendo |
| 🇺🇸 [Kanji.sljfaq](https://kanji.sljfaq.org) | Website que mostra imagem em `.png` ou `.svg` da ordem dos traços enumerados e nos bastidores usa o kanji-colorize que também é usado no complento do Anki Kanji Colorizer |
| 🇺🇸 [Kanji.sljfaq](https://kanji.sljfaq.org) | Website que mostra imagem em `.png` ou `.svg` da ordem dos traços enumerados e nos bastidores usa o kanji-colorize que também é usado no complento do Anki Kanji Colorizer |
| [Katsu](https://katsu.arthurhoek.nl/#/home "Katsu: practise Japanese conjugation") | Praticar conjugação do japonês, semelhante ao Japanese Conjugator Pratice |
...
| 🇺🇸 [Nadeshiko](https://nadeshiko.co "Uma ferramenta para pesquisar palavras e frases em japonês em vários contextos") | Pesquisar palavras e frases em japonês em vários contextos em animes. Possui integração com o Anki |
| 🇺🇸 [Yamasa](https://db.yamasa.org/ocjs/kanjidic.nsf/SearchKanji3?OpenForm "Yamasa") | Pesquisar por um kanji desejado e ele mostra um `.gif` da ordem dos traços com marcação quadriculada, porém sem enumeração da ordem |
...
| Nome | Descrição |
|:---- |:--------- |
| 🇺🇸 [Animelon](https://animelon.com) | Assistir animes com legendas em japonês  |
| ⭐[Jimaku](https://jimaku.cc "Jimaku - Legendas de animes em japonês") | Legendas de animes em japonês. Uma alternativa ao Kitsunekko, possui uma forma de pesquisa melhor e referência do anime para o Anilist |
| 🇺🇸 [Kitsunekko](http://kitsunekko.net) | Legendas de animes em japonês, inglês, chinês e coreano |
...
| 🇧🇷 [Como fazer seus próprios mangás pro Kindle (tutorial)](https://youtu.be/a9g1z0u7vtk?si=KTHLW9FB3K4IYBho "Como fazer seus próprios mangás pro Kindle (tutorial) por @funkypaiCat no YouTube") | Como você mesmo pode converter mangás para o formato do Kindle |
...
| Nome | Descrição |
|:---- |:--------- |
| 🇺🇸 [1000 Japanese basic words](https://en.wiktionary.org/wiki/Appendix:1000_Japanese_basic_words "1000 Japanese basic words") | Um apêndice/lista de vocabulário com 1000 palavras básicas japonesas | 
| ⭐🇺🇸 [3000 common JP words](https://docs.google.com/spreadsheets/d/1cT16lcMnSoWW_VNO8DgPMKhPkXVj41ow7RZ0kuZQ4Jk "3000 common JP words") |Planilha com lista de vocabulário das 3000 palavras mais comuns no japonês |
| [100+ Podcasts](https://docs.google.com/spreadsheets/d/17P2dBQHnBnHcG3ua_24IO6sP9RDC-5b3WHV9Ri2N5qU/edit?gid=0#gid=0 "100+ Podcasts") | Lista de podcasts com classificação de dificuldade |
...
| ⭐🇺🇸 [Japanese Media Recommendations](https://docs.google.com/spreadsheets/d/1w42HEKEu2AzZg9K7PI0ma9ICmr2qYEKQ9IF4XxFSnQU "Japanese Media Recommendations") | Planilha com recomendação de conteúdos para fazer imersão |
...
| ⭐🇺🇸 [Tanos](http://www.tanos.co.uk/jlpt) | Website com listas de kanjis e vocabulário requeridos em cada nivel do JLPT(*Japanese Language Proficiency Test*) com decks para o Anki, pdfs, planilhas e etc | 
| 🇺🇸 [The Resources](https://kuzuri.neocities.org/resources "The Resources") | Lista de diversos recursos úteis, igualmente é essa própria lista daqui. Muitos recursos já citados por aqui aparecem nessa lista também |
